...
#define IMAGEM2(X, Y, ESCALA, FICHEIRO)		printf("<image x=%f y=%f width=%d height=%d xlink:href=%s />\n", \
												ESCALA * X, ESCALA* Y, ESCALA, ESCALA, IMAGE_PATH FICHEIRO)
...
@param ESCALA A escala do quadrado
@param COR A cor de preenchimento do quadrado
@param OPACITY A opacidade do quadrado
*/

#define QUADRADO2(X, Y, ESCALA, COR, OPACITY)			printf("<rect x=%d y=%d width=%d height=%d fill=%s fill-opacity=%f />\n", \
												ESCALA * X, ESCALA* Y, ESCALA, ESCALA, COR, OPACITY)
